...
import com.fmovies.app.adapters.CastCrewAdapter;
import com.fmovies.app.adapters.CommentsAdapter;
import com.fmovies.app.adapters.EpisodeAdapter;
import com.fmovies.app.adapters.DownloadAdapter;
import com.fmovies.app.adapters.HomePageAdapter;
import com.fmovies.app.adapters.LiveTvHomeAdapter;
import com.fmovies.app.adapters.ProgramAdapter;
import com.fmovies.app.adapters.ServerApater;
import com.fmovies.app.database.DatabaseHelper;
import com.fmovies.app.models.CastCrew;
import com.fmovies.app.models.GetCommentsModel;
import com.fmovies.app.models.CommonModels;
import com.fmovies.app.models.EpiModel;
import com.fmovies.app.models.PostCommentModel;
import com.fmovies.app.models.Program;
import com.fmovies.app.models.SubtitleModel;
import com.fmovies.app.models.single_details.Cast;
import com.fmovies.app.models.single_details.Director;
import com.fmovies.app.models.single_details.DownloadLink;
import com.fmovies.app.models.single_details.Episode;
import com.fmovies.app.models.single_details.Genre;
import com.fmovies.app.models.single_details.RelatedMovie;
import com.fmovies.app.models.single_details.Season;
import com.fmovies.app.models.single_details.SingleDetails;
import com.fmovies.app.models.single_details.Subtitle;
import com.fmovies.app.models.single_details.Video;
import com.fmovies.app.network.RetrofitClient;
import com.fmovies.app.network.apis.CommentApi;
import com.fmovies.app.network.apis.FavouriteApi;
import com.fmovies.app.network.apis.SingleDetailsApi;
import com.fmovies.app.network.apis.SubscriptionApi;
import com.fmovies.app.network.model.ActiveStatus;
import com.fmovies.app.network.model.AdsConfig;
import com.fmovies.app.network.model.FavoriteModel;
import com.fmovies.app.service.DownloadWorkManager;
import com.fmovies.app.utils.PreferenceUtils;
import com.fmovies.app.utils.ApiResources;
import com.fmovies.app.utils.ads.BannerAds;
import com.fmovies.app.utils.Constants;
import com.fmovies.app.utils.ads.PopUpAds;
import com.fmovies.app.utils.ToastMsg;
import com.fmovies.app.utils.Tools;
import com.fmovies.app.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.fmovies.app.Config.API_KEY, userId);
